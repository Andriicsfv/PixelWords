...
public class UIManager : MonoBehaviour
{
    ...
    public void ShowCard(WordData info)
    {
        ...
        if (ShopManager.Instance != null && ShopManager.Instance.isFirstDayWithFriend)
        {
    ...
    public void CloseCard() => _learningPanel.SetActive(false);
